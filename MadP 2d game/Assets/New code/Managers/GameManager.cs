...
namespace RushNDestroy
{
    public class GameManager : MonoBehaviour
    {
        ...
        public PlaceablesData castlePData;
        ...
        public void UseCard(CardData cardData, Vector3 position, Placeable.Faction pFaction)
        {
            ...
            {
                PlaceablesData pDataRef = cardData.placeablesData[pNum];
        ...
        private void SetupPlaceable(GameObject go, PlaceablesData pDataRef, Placeable.Faction pFaction)
        {
...
//----------------------------------------------------------------------------------
                    //----- Atkomentuoti jei nori kad pilis gautu damage
