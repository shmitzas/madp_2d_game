...
//         private void SpawnSetup(GameObject go, PlacableEntities entity)
//         {
//             switch (entity.entityType)
//             {
//                 case EntityData.Type.Character:
//                     Unit uScript = go.GetComponent<Unit>();
//                     HealthBar hb = go.GetComponentInChildren<HealthBar>();
//                     uScript.Activate(entity);
//                     uScript.health = entity.health;
//                     Debug.Log(uScript.name + " " + "health" + uScript.health);
//                     hb.SetHealth(entity.health);
//                     break;
//             }
//         }
//         private void Update()
